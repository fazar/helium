<?php
	class DC_about_widget extends WP_Widget{
		function __construct(){
			$widget_ops = array(
				'classname' => 'dc_about_widget', 
				'description' => __( "The description about your site or profile.", THEMENAME) );
			parent::__construct('dc-about-widget', 'Decode - ' . __('About', THEMENAME), $widget_ops);
			$this->alt_option_name = 'dc_present_widget';
		...
		function update( $new_instance, $old_instance ) {
			...
			if ( isset($alloptions['dc_about_widget']) )
				delete_option('dc_about_widget');
			return $instance;
		}
