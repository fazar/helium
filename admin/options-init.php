...
if (!class_exists('helium_admin_config')) {
    ...
    class helium_admin_config {
        ...
        public function __construct() {
            ...
            $this->dc_options = new DC_options();
        ...
        public function setSections() {
            ...
            $this->sections[] = $this->dc_options->get_general_options();
            ...
            $this->sections[] = array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            'subtitle' => 'Choose the default navigation color schema. (this will not be applied when you are using fullscreen slider/background template',
                            'default' => 'light-color',
                            'options' => array(
                                'light-color' => 'Light Font Color',
                                'dark-color' => 'Dark Font Color',
                                'custom' => 'Custom Color Schema'
                            )
                        )
                    )
                );
            ...
            $this->sections[] = array(
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'type' => 'radio', 
                        'title' => __('Footer Color Scheme', THEMENAME),
                        'subtitle' => __('Choose your color scheme', THEMENAME),
                        'default' => 'light-color',
                        'desc' => __('', THEMENAME),
                        'options' => array(
                            'light-color' => __('Light Font Color', THEMENAME),
                            'dark-color' => __('Dark Font Color', THEMENAME),
                            'custom' => __('Custom Font Color', THEMENAME)
                        )
                    ),
                    array(
